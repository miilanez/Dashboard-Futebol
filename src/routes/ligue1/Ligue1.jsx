...
import Ligue1Logo from "../../assets/images/logos/ligue1.png";
...
//imports api
import useLigue1 from "../../services/api/ligue1/useLigue1";
      ...
      {loading ? (
        ...
        <div className="main-container">
          <div className="upper-container">
            <div>
              <PageTitle title="Ligue 1" logoLeague={Ligue1Logo} />
            </div>
            <div>
          ...
          <div className="downner-container">
            ...
            <Standings data={standing} title="Ligue 1" />
          </div>
        </div>
      )}
    </div>
